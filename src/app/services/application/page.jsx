...
export default function Page() {
  ...
  const [certificateType] = useState("अर्ज करा");
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-2">
      ...
      <div className="bg-green-700 text-white px-6 py-4 flex items-center gap-3">
        ...
        <h1 className="text-lg font-semibold"> अर्ज करा</h1>
      </div>
  ...
  method="POST"
        ...
        >
          ...
          <div>
            <label className="font-medium">
               अर्ज करणाऱ्याचे नाव  <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name="full_name"
          ...
          <div>
            <label className="font-medium">
              अर्ज माहिती  /  application description{" "}
