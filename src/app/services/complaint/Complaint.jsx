...
export default function Complaint() {
  ...
  const [certificateType] = useState("तक्रार");
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-2">
      ...
      <div className="bg-green-700 text-white px-6 py-4 flex items-center gap-3">
        ...
        <h1 className="text-lg font-semibold">तक्रार</h1>
      </div>
      ...
      <div className="bg-white mx-6 my-6 p-6 rounded shadow">
        ...
        >
          ...
          <div>
            <label className="font-medium">
              तक्रारदाराचे नाव  / Full Name <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name="full_name"
          ...
          <div>
            <label className="font-medium">
              तक्रार माहिती  /  complaint description{" "}
